...
SCENARIOS = [
    ...
    Scenario('series_eden_edition_groups_compact', 'edition_groups', '/series/Eden/edition-groups', {}, frozenset({'quick', 'standard', 'stress'})),
    Scenario('series_eden_edition_groups_full', 'edition_groups_full', '/series/Eden/edition-groups', {'include_volumes': 'true'}, frozenset({'standard', 'stress'})),
    Scenario('search_eden_editions', 'edition_search', '/search/editions', {'q': 'eden', 'mode': 'best', 'limit': 1}, frozenset({'standard', 'stress'})),
    Scenario('volume_eden_perfect_1_by_number', 'volume_projection', '/volume/Eden/number/1', {'edition_label': 'perfect', 'fields': 'title,number,publication_date,isbn_ean'}, frozenset({'stress'})),
