...
@app.get('/search', dependencies=[Depends(auth_dependency)])
async def search(
...
@app.get('/volume/{series_slug}/{volume_slug}', dependencies=[Depends(auth_dependency)])
...
@app.get('/volume/by-url', dependencies=[Depends(auth_dependency)])
...
@app.get('/news/global', dependencies=[Depends(auth_dependency)])
...
@app.get('/news/series/{slug}', dependencies=[Depends(auth_dependency)])
...
@app.get('/news/volume/{series_slug}/{volume_slug}', dependencies=[Depends(auth_dependency)])
...
@app.get('/news/volume/by-url', dependencies=[Depends(auth_dependency)])
